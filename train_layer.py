...
# projects=['argouml2']
projects=['poi'] #'ambari_upsample37' 'ant1 'argouml2', 'hibernate_upsample50', 'jenkins_upsample35', 'jmeter_upsample_42', 'lucene3', 'poi'

for layer in range(9,10):
    for project in projects:
        for count in range(3,args.counts):
            ...
            for epoch in epochs:# without batching
                ...
                path = 'result/predict_result/layer/{}/{}'.format(layer,project)
