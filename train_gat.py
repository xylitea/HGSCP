...
parser.add_argument("--num_layers", default=1)  #8
...
for project in projects:
    for count in range(6,args.counts):
        ...
        model=model3.GAT(vocablen,embedding_dim=100,num_heads=num_layers,device=device).to(device)
        ...
        for epoch in epochs:# without batching
            ...
            path = 'result/predict_result/GAT/{}'.format(project)
