...
projects=['poi_upsample41'] #'ambari_upsample37' 'ant1 'argouml2', 'hibernate_upsample50', 'jenkins_upsample35', 'jmeter_upsample_42', 'lucene3', 'poi'
...
for project in projects:
    for count in range(2,args.counts):
        ...
        for epoch in epochs:# without batching
            ...
            path = 'result/predict_result/simplifyedgeemb/{}'.format(project)
