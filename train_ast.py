...
projects=['argouml','hibernate_upsample50', 'jenkins_upsample35', 'jmeter_upsample42', 'lucene3_upsample33', 'poi_upsample41'] 
# 'ambari_upsample37', 'ant1_upsample39',
for project in projects:
    ...
    traintime=0
    testtime=0
    for count in range(args.counts,args.counts+30):
        ...
        for epoch in epochs:# without batching
            ...
            path = 'result/predict_result/ast-ggnn/multi/{}'.format(project)
