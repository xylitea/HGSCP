...
# projects=['poi_upsample41'] #'jenkins_upsample35'

projects=['ant1_upsample39','argouml','poi_upsample41', 'lucene3_upsample33','hibernate_upsample50']
...
for project in projects:
    ...
    for h in range(2,count):
        ...
        ppl = pipeline.Pipeline('data/baseline/programs_'+project+'.pkl')
        train,test=ppl.run()
        ...
        for epoch in range(epochs):
            ...
            path = 'result/predict_result/{}'.format(project)
