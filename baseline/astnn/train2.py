...
res = [] 
projects=['lucene']  #   'ambari','hibernate','jenkins'  poi  'lucene'
# projects = ['ambari']
data = []
data_avg = []
...
for project in projects:
    ...
    for h in range(11,20):
        ...
        HIDDEN_DIM = 100
        # HIDDEN_DIM = 200   # ant  10
        # HIDDEN_DIM = 300   # hibernate    13\15    10
        # HIDDEN_DIM = 85   # jmeter      
        # HIDDEN_DIM =120   # jackrabbit
        ENCODE_DIM = 128
        # LABELS = 104
        LABELS = 2
        EPOCHS = 15
