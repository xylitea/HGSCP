...
for project in projects:
    ...
    for count in range(4,5):
        ...
        model=models_tmp.GGNN(vocablen,embedding_dim=100,num_layers=num_layers,device=device).to(device)
        ...
        for epoch in epochs:# without batching
            ...
            path = 'result/predict_result/simplifyedge/newsmallweight/{}'.format(project)
